<template>
    <!-- View Question Bank Starts Here -->
    <TransitionRoot as="template" :show="openEditProjectSidebar">
      <Dialog as="div" class="relative z-10" @close="openEditProjectSidebar = false">
                    ...
                    <div class="px-4 sm:px-6">
                      <div class="flex items-start justify-between">
                        <DialogTitle
                          ...
                          >View Question Bank</DialogTitle
                        >
                        <div class="ml-3 flex h-7 items-center">
                          <button
                            type="button"
                            class="rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                            @click="openEditProjectSidebar = false"
                          >
                    ...
                    >
                      ...
                      <div class="mt-2">
                        <div class="mt-2">
                          ...
                          <select
                            name="category"
                            id="category"
                            v-model="getProjectData.category"
                            class="pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                          >
                      ...
                      <div class="mt-2">
                        ...
                        <select
                          name="sub_category"
                          id="sub_category"
                          v-model="getProjectData.sub_category"
                          class="pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        >
                      ...
                      <div class="mt-2">
                        ...
                        <div class="mt-2">
                          <input
                            id="details"
                            v-model="getProjectData.details"
                            class="pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                      ...
                      <div class="mt-2">
                        ...
                        <div class="mt-2">
                          <input
                            ...
                            v-model="getProjectData.total_project_area"
                            class="pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                      ...
                      <div class="mt-2">
                        ...
                        <div class="mt-2">
                          <input
                            ...
                            v-model="getProjectData.listing_type_name"
                            class="pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
  ...
  const props = defineProps({
    openEditProjectSidebar: Boolean,
  ...
  // On clicking on save button we emit updated data to parent file
  const saveFormData = () => {
  emit("formData", props.getProjectData);
