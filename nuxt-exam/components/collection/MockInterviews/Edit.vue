<template>
    <TransitionRoot as="template" :show="viewModal">
      <Dialog as="div" class="relative z-10" @close="viewModal = false">
        <TransitionChild
          as="template"
          ...
          >
            ...
            >
              ...
              >
                <div>
                  ...
                  <div class="mt-3 text-center sm:mt-5">
                    <DialogTitle
                      ...
                      >View Mock Interview</DialogTitle
                    >
                      ...
                      <form>
                        <div class="mt-2 pl-2">
                            ...
                            <div class="mt-2">
                              <input
                                id="name"
                                v-model="viewMockInterviewDetails.name"
                        ...
                        <div class="mt-[-2.75rem] mr-[-15.75rem]">
                            ...
                            <input
                              ...
                              name="type"
                              value="practice"
                              v-model="viewMockInterviewDetails.type"
                            />
                        ...
                        <div class="mt-2 pl-2">
                          ...
                          <div class="mt-2">
                            <input
                              type="number"
                              id="max_time_allowed"
                              v-model="viewMockInterviewDetails.max_time_allowed"
                              class="pl-2 block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        ...
                        <div class="mt-2 pl-2">
                          ...
                          <div class="mt-2">
                            <textarea
                              id="description"
                              v-model="viewMockInterviewDetails.description"
                              class="pl-2 block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        ...
                        <div class="mt-2 pl-2">
                          ...
                          <div class="mt-2 pb-2">
                            <input
                              id="status"
                              type="number"
                              v-model="viewMockInterviewDetails.status"
                              class="pl-2 block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                ...
                <div
                  class="mt-5 sm:mt-6  sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3"
                >
                  <button
                    type="button"
  ...
  const props = defineProps({
    viewModal: Boolean,
    viewMockInterviewDetails:Object
  });
