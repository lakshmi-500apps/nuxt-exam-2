<template>
  <TransitionRoot as="template" :show="openEditDetailsModal">
    <Dialog
      as="div"
      class="relative z-10"
      @close="openEditDetailsModal = false"
    >
      <TransitionChild
        as="template"
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  @click="openEditDetailsModal = false"
                  ref="cancelButtonRef"
                >
                  Cancel
                </button>
...
const updateDetails = () => {
  emit("updateDetails", props.editDetails);
  props.editDetails = {};
};
</script>
